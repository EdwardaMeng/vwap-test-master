...
public class ExpectationTest {
  ...
  public void singleThreaded() {
    shouldMatchPracticeExpectation(1);
  }

  @Test
  @Timeout(value = 2, unit = TimeUnit.MINUTES, threadMode = Timeout.ThreadMode.SAME_THREAD)
  public void multiThreaded() {
    shouldMatchPracticeExpectation(4);
  }

  private void shouldMatchPracticeExpectation(int nbThreads) {
    C p = com.hsoft.internal.D.m(nbThreads);
    p.a(vwapTrigger);
    p.b(vwapTrigger);
    p.c();
